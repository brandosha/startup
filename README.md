...
- [x] **Stores data in MongoDB** - User accounts, posts, and comments are stored in MongoDB.
- [x] **Stores credentials in MongoDB** - Hashed passwords and session tokens are stored in MongoDB.

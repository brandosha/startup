...
I had to use localStorage to store the authToken and send it in the `Authorization` header because my browser was blocking the cross-site cookies since my development server was on a different port than the web app hosted by vite.